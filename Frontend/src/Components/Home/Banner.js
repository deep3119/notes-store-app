                ...
                <div className="d-flex flex-column flex-md-row">
                    <div className="left col w-100  md-w-50">
                        <div className="my-5">
                            ...
                            <p className='py-2'>Notes are succinct records of information, typically
                             taken during lectures, meetings, or while reading, to capture key points, 
                             ideas, and details for later reference. They serve as a condensed version of 
                             larger bodies of information, aiding in comprehension, retention, and organization.
                              Notes can be handwritten or digital.</p>
